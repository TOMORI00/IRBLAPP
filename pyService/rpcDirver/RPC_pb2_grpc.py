...
class ComputeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.compute = channel.unary_unary(
                '/Compute/compute',
                request_serializer=RPC__pb2.ComputeRequest.SerializeToString,
                response_deserializer=RPC__pb2.ComputeReply.FromString,
                )
...
def add_ComputeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'compute': grpc.unary_unary_rpc_method_handler(
                    servicer.compute,
                    request_deserializer=RPC__pb2.ComputeRequest.FromString,
                    response_serializer=RPC__pb2.ComputeReply.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class Compute(object):
    ...
    def compute(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Compute/compute',
            RPC__pb2.ComputeRequest.SerializeToString,
            RPC__pb2.ComputeReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
