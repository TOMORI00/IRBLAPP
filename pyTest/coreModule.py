...
class CoreModule:
    ...
    def buildReport_Cosine(self, alpha):
        ...
        #                     self.report_FinalScore[reportName][self.CodeNames[i]] = 0.5
        #                 else:
        #                     self.report_FinalScore[reportName][self.CodeNames[i]] += 0.1
...
if __name__ == '__main__':
    ...
    with open('SIM_SWT_Iteration2.json', 'w') as file_obj:
