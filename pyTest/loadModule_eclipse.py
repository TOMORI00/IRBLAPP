...
class LoadModule:
    def read_origin_reports(self):
        with open('./../JSON-Eclipse/JSON-SUMMARY&DESCRIPTION-NewEclipseBugRepository.json', encoding='utf-8') as f:
            reports = json.load(f)
        return reports
    ...
    def read_report(self):
        ...
        #     reports[file] = data
        with open('./../pyService/FilterService/Eclipse_SummaryAndDescription.json') as f:
            reports = json.load(f)
        return reports
    ...
    def read_codes(self):
        ...
        #     codes[file] = data
        with open('.././pyService/FilterService/resultsOfAST/eclipse-3.1/processedallWords.json', encoding='utf-8') as f:
            codes = json.load(f)
        return codes

    def read_methods(self):
        with open('./../pyService/FilterService/resultsOfAST/eclipse-3.1/processedmethods.json') as f:
            methods = json.load(f)
        return methods

    def read_classes(self):
        with open('./../pyService/FilterService/resultsOfAST/eclipse-3.1/processedclasses.json') as f:
            classes = json.load(f)
        return classes

    def read_attributes(self):
        with open('./../pyService/FilterService/resultsOfAST/eclipse-3.1/processedattributes.json') as f:
            attributes = json.load(f)
        return attributes

    def read_comments(self):
        with open('./../pyService/FilterService/resultsOfAST/eclipse-3.1/processedcomments.json') as f:
            comments = json.load(f)
        return comments

    def read_summaries(self):
        with open('./../pyService/FilterService/Eclipse_Summary.json') as f:
            summaries = json.load(f)
        return summaries

    def read_descriptions(self):
        with open('./../pyService/FilterService/Eclipse_Description.json') as f:
            descriptions = json.load(f)
        return descriptions

    def read_fixedfiles(self):
        with open('./../JSON-Eclipse/JSON-FIXEDFILES-NewEclipseBugRepository.json') as f:
    ...
    def read_fixdate(self):
        with open('./../JSON-Eclipse/JSON-FIXDATE-NewEclipseBugRepository.json') as f:
            fixdate = json.load(f)
        return fixdate


    def read_opendate(self):
        with open('./../JSON-Eclipse/JSON-OPENDATE-NewEclipseBugRepository.json') as f:
...
if __name__ == '__main__':
    ...
    print(loadModule.read_fixedfiles())
